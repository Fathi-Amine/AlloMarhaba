                            ...
                            {searchType === 'place' && (
                                <div>
                                    <input
                                        ...
                                        className='shadow appearance-none border rounded w-full py-2 px-3 mt-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text"'
                                    />
                                    <button onClick={() => searchType === 'place' && performSearch(searchType)} className='flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded mt-3'>Search</button>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                        {restaurants.length > 0 ? (
                            restaurants.map((restaurant) => (
                                <div key={restaurant.id} className='restaurants-cart mb-5 col-lg-4 col-md-6 col-sm-12'>
                                    <div>
                                        <img
                                            src={restaurantPhoto}
                                            alt={restaurant.name}
                            ...
                            <p className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative font-semibold" >No Restaurants Found.</p>
                        )}
                    </div>
                </div>
            </div>
                            ...
                            >
                                <Popup >
                                    <div>
                                        ...
                                        <Link to={`/${location.name}/products`}>Order</Link>
                                    </div>
                                </Popup>
                            </Marker>
                        ))}
