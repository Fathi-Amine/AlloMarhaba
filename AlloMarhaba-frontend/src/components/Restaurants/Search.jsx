...
const Search = () => {
    ...
    const SEARCH_CHUNK = '/search';
    const SEARCH_BY_NAME_URL = '/searchByName';
    const SEARCH_BY_CUISINE_TYPE_URL = '/searchByCuisineType';
    const SEARCH_BY_PLACE_URL = '/searchByPlace';
    const CUISINE_TYPE_URL = '/cuisine-type';
    ...
    const fetchCuisineType = async () => {
        try {
            const { data } = await api.get(CUISINE_TYPE_URL);
    ...
    const performSearch = async (selectedType) => {
        try {
            ...
            switch (selectedType) {
                case 'name':
                    apiUrl = SEARCH_BY_NAME_URL;
                    break;
                case 'cuisineType':
                    apiUrl = SEARCH_BY_CUISINE_TYPE_URL;
                    break;
                case 'place':
                    apiUrl = SEARCH_BY_PLACE_URL;
                    break;
                default:
                    apiUrl = SEARCH_URL;
                    break;
